...
public class CollectJRARaceInfoPage extends JDialog {
	...
	private final JLabel labelInformation = new JLabel(
			"<html>JRAのサイトからスクレイピングを行います。<br>以下のチェックボックスから、取得したい情報を選択してからOKボタンを押してください。<br>※レース2日前とかは、馬体重など欲しいデータがそもそもwebにないためエラーとなります。");
	...
	public CollectJRARaceInfoPage() {
		...
		// inputAreaRaceRound.setLineWrap(true);
